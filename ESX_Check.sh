...
echo "https://www.vmware.com/resources/compatibility/search.php?deviceCategory=io&details=1&VID=$VID&DID=$DID&SVID=$VID&SSID=$SSID&page=1&display_interval=10&sortColumn=Partner&sortOrder=Asc"
echo "-------------------------------------------------"
done
